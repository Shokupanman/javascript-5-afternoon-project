...
function Movie(name, genre, rating) {
  ...
  Movie.prototype.changeRating = function (num) {
    let averageRating = (rating + num) / 2
...
//that will take in one number parameter representing the post id. Use this id to find and remove the matching object in the savedPosts array.
